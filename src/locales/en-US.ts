export default {
  ...
  index_roadmap_step_one_2:
    'Contract Deployment Open Casting, Genesis Novel Release',
  index_roadmap_step_two_1: 'Project Optimization',
  index_roadmap_step_two_2:
    'Restructured website, new release. Internationalization',
  index_roadmap_step_three_1: 'NFT Design',
  index_roadmap_step_three_2:
    'Created based on the background of the creation novel PFP',
  index_roadmap_step_four_1: 'Host a Science ',
  index_roadmap_step_four_2: 'Building a first-class science fiction community',
  index_roadmap_step_five_1: 'The Dream',
