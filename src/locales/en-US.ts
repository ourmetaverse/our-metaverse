export default {
  ...
  index_benefit_grant_content:
    'Possess the right to modify and translate the digital form of all works contained in the OurMetaverseDAO portfolio, allowing for secondary authoring. The business authorization logic of Erchuang is realized through smart contracts.',
  ...
  index_roadmap_step_one_1: 'Publish the project',
  index_roadmap_step_one_2: 'Start mint',
